...
if( true )//isGet("imei") )
{
	...
	$sql = "SELECT * FROM _g_data where TRUE ORDER BY id DESC LIMIT 200";
	...
	if ($result->num_rows > 0)
	{
		...
		while($row = $result->fetch_assoc())
		{
			...
			$latlng = "";
			$sql2 = "SELECT * FROM _f_device where dev_id='".$row["device"]."' LIMIT 1";
			$result2 = $conn->query($sql2);
			if ($result2->num_rows > 0)
			{
				$row2 = $result2->fetch_assoc();
				$latlng = $row2["lat"].",".$row2["lng"];
			}
	...
	{
		$outp = '{"Time":"--","IMEI":"--","V1":"--","V2":"--","V3":"--","V4":"--","V5":"--","V6":"--","V7":"--","V8":"--","V9":"--","V10":"--","V11[2,3,4]":"--","V11[2]":"--","V11[3]":"--","V11[4]":"--","V11[5]":"--","V11[6]":"--","V11[7]":"--","V12":"--","V13":"--","V14":"--","V15":"--","V16":"--","V17":"--","V18":"--","V19":"--","V20":"--"}';
		echo '{"result":['.$outp.']}';
	}
}
?>