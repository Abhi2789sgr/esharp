...
if( isGet("imei") )
{
	...
	if ($result->num_rows > 0)
	{
		...
		$outp .= '{"a":"N/A","b":"Pfault"},';
		$outp .= '{"a":"<b><small>SSL Fault Date</small></b>","b":""},';
		$outp .= '{"a":"N/A","b":"LfaultD"},';
		$outp .= '{"a":"<b><small>SSL Fault Time</small></b>","b":""},';
		$outp .= '{"a":"N/A","b":"LfaultT"},';
		$outp .= '{"a":"<b><small>SSL ON Time</small></b>","b":""},';
		$outp .= '{"a":"--","b":"onTime"},';
		$outp .= '{"a":"<b><small>SSL OFF Time</small></b>","b":""},';
		$outp .= '{"a":"--","b":"offTime"},';
