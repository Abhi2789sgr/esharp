				...
				?>
				  <tr>
					...
					<td>
						...
						<button class="w3-button w3-red m8-fancy" style="width:100px;" onclick="deleteDevice(<?php echo $row["dev_id"]; ?>)">Delete</button><br><br>
...
{	
	var param  = "imei="+imei;
	ajax("../Controller/admin/deleteDevice.php",param,1);
}
