    ...
    <div class="w3-quarter">
      <div class="w3-container w3-orange w3-text-white w3-padding-16 m8-fancy">
        ...
        <div class="w3-right">
		  ...
		  <?php 
		  $pwr = "0";
		  $sql = "SELECT count(id) as id FROM _g_data where device IN (SELECT dev_id FrOM _f_device where ".$entry."='".$branch_value."')";
		  $result = $conn->query($sql);
		  if ($result->num_rows > 0)
		  {
    ...
    <div class="w3-quarter w3-button0" onclick0="window.location.assign('?item=2')">
      <div class="w3-container w3-indigo w3-padding-16 w3-hover-red0 m8-fancy">
        ...
        <div class="w3-right">
		  ...
		  if($branch == 6)
		  {
			$sql = "SELECT count(id) as id FROM _b_district where parent='".$branch_value."'";
			$result = $conn->query($sql);
			if ($result->num_rows > 0)
			{
			  $row = $result->fetch_assoc();
    ...
    <div class="w3-quarter">
      <div class="w3-container w3-purple w3-padding-16 m8-fancy">
        ...
        <div class="w3-right">
		  ...
		  <?php 
		  if($branch == 6)
		  $sql = "SELECT count(id) as id FROM _c_block WHERE parent IN (SELECT id FROM _b_district where parent='".$branch_value."')";
		  else if($branch == 5)
		  $sql = "SELECT count(id) as id FROM _c_block WHERE parent='".$branch_value."'";
		  else if($branch == 4)
		  $sql = "SELECT 1 as id";
		  else
		  $sql = "SELECT 0 as id;";
    ...
    <div class="w3-quarter">
      <div class="w3-container w3-green w3-padding-16 m8-fancy">
        ...
        <div class="w3-right">
		  ...
		  <?php 
		  if($branch == 6)
		  $sql = "SELECT count(id) as id FROM _d_panchayat where parent IN (SELECT id FROM _c_block WHERE parent IN (SELECT id FROM _b_district where parent='".$branch_value."'))";
		  else if($branch == 5)
		  $sql = "SELECT count(id) as id FROM _d_panchayat where parent IN (SELECT id FROM _c_block WHERE parent='".$branch_value."')";
		  else if($branch == 4)
		  $sql = "SELECT count(id) as id FROM _d_panchayat where parent='".$branch_value."'";
		  else if($branch == 3)
		  $sql = "SELECT 1 as id";
		  else
		  $sql = "SELECT 0 as id;";
    ...
    <div class="w3-quarter">
      <div class="w3-container w3-deep-orange w3-text-white w3-padding-16 m8-fancy">
        ...
        <div class="w3-right">
		  ...
		  <?php 
		  if($branch == 6)
		  $sql = "SELECT count(id) as id FROM _e_ward where parent IN (SELECT id FROM _d_panchayat where parent IN (SELECT id FROM _c_block WHERE parent IN (SELECT id FROM _b_district where parent='".$branch_value."')))";
		  else if($branch == 5)
		  $sql = "SELECT count(id) as id FROM _e_ward where parent IN (SELECT id FROM _d_panchayat where parent IN (SELECT id FROM _c_block WHERE parent='".$branch_value."'))";
		  else if($branch == 4)
		  $sql = "SELECT count(id) as id FROM _e_ward where parent IN (SELECT id FROM _d_panchayat where parent='".$branch_value."')";
		  else if($branch == 3)
